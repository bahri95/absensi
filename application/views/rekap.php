                                   ...
                                   <div class="table-responsive">
                                    ...
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead>
                                          ...
                                          <tr>
                                               ...
                                               <td><?php echo $datanya['tgl_mobilisasi'];?></td>
                                               <td><?php echo $datanya['tgl_demobilisasi'];?></td>
                                    ...
                                    <div class="container">
                                      <div class="form-group">
                                        <br/>
                                        <a href="<?php echo base_url('rekap/export'); ?>" class="btn btn-primary">Cetak</a>
                                      </div>
                                     </div>
                                </div>
                            </div>
